...
func d1_1() {
	...
	zap.L().With(zap.Int64("sum", sum)).Info("done")
}

func d1_2() {
	letterDigitReplace := orderedmap.New[string, string]()
	// letterDigitReplace={
	// 	"twone": "21", "one": "1", "two": "2", "three": "3",
	// 	"four": "4", "five": "5", "six": "6",
	// 	"seven": "7", "eigh": "8", "nine": "9",
	// }

	letterDigitReplace.Set("twone", "21")
	letterDigitReplace.Set("nineigh", "98")
	letterDigitReplace.Set("oneigh", "18")
	letterDigitReplace.Set("threeigh", "38")
	letterDigitReplace.Set("fiveigh", "58")
	letterDigitReplace.Set("sevenine", "78")
	letterDigitReplace.Set("one", "1")
	letterDigitReplace.Set("two", "2")
	letterDigitReplace.Set("three", "3")
	letterDigitReplace.Set("four", "4")
	letterDigitReplace.Set("five", "5")
	letterDigitReplace.Set("six", "6")
	letterDigitReplace.Set("seven", "7")
	letterDigitReplace.Set("eigh", "8")
	letterDigitReplace.Set("nine", "9")
	inputStr := `
	5ffour295
m9qvkqlgfhtwo3seven4seven
2vdqng1sixzjlkjvq
...
cqmzqbxzfvonevmmmlxsnjr5zfg
		...
		`
	// for k, v := range letterDigitReplace {
	// 	// inputStr = strings.ReplaceAll(inputStr, v, "")
	// 	inputStr = strings.ReplaceAll(inputStr, k, v)
	// }
	for pair := letterDigitReplace.Oldest(); pair != nil; pair = pair.Next() {
		inputStr = strings.ReplaceAll(inputStr, pair.Key, pair.Value)
	}
...
func calibraNumber(input string) int64 {
	firstNum := 0
	secondNum := 0
	...
	return int64(firstNum)*10 + int64(secondNum)
}
